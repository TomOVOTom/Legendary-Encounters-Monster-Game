...
public class MonsterGame {
    ...
    public static void main(String[] args) {
        ...
        Player player = null;
        Mount horse = new Mount("战马", 50, 100, 10, 10, 6,100); // Initialize the mount here
        ...
        while (player.hp > 0) { // 当玩家还有生命值时，继续战斗
            ...
            System.out.println("请选择你的行动：1. 探索 2. 休息 3. 查看装备和物品 4. 保存游戏 5. 开始战斗 6. 退出游戏 7. 设置音量 8. 播放背景音乐 9. 管理坐骑 10. 读取存档");
