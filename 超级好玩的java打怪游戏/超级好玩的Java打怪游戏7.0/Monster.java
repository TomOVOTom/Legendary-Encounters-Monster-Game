                ...
                switch (abilityName) {
                    ...
                    case "暗影爆发":
                        ...
                        if (this.stamina >= staminaCost) {
                            ...
                            player.addStatusEffect(new StatusEffectManager.StatusEffect(StatusEffectType.FEAR, 2, -10)); // 假设效果
                            this.stamina -= staminaCost;
                        }
                        break;
                    case "冰封禁锢":
                        ...
                        if (this.stamina >= staminaCostFrozen) {
                            ...
                            player.addStatusEffect(new StatusEffectManager.StatusEffect(StatusEffectType.CHILLED, 2, 10)); // CHILLED效果，持续2回合
