...
public class InventoryManager {
    ...
    public static void useItem(Player player, Scanner scanner) {
        ...
        try {
            ...
            for (int i = 0; i < itemNames.length; i++) {
                System.out.println((i + 1) + ". " + itemNames[i] + " x" + ((Item) player.inventory.get(itemNames[i])).getQuantity());
            }
            ...
            player.removeFromInventory(selectedItemName, 1);
    ...
    public static void displayInventory(Player player) {
        ...
        for (Map.Entry<String, Object> entry : player.inventory.entrySet()) {
