...
public class Mount implements Serializable {
    ...
    public int attackBonus; // 新增攻击力加成属性
    public int defenseBonus; // 新增防御力加成属性
    public int price; // 新增价格属性
    ...
    public void ride(Player player) {
        if (stamina > 0) {
            ...
            stamina -= 10;
            MountManager.restoreHealth(player, speed); // 根据速度恢复玩家血量
        } else {
    ...
    public static void displayMountAttributeBonuses(Mount mount) {
