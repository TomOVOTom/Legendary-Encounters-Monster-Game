...
public class GameActions {
    public static void performAction(Player player, Random random, QuestManager questManager, int actionChoice) {
        switch (actionChoice) {
            case 1:
                Explorer.explore(player, random, questManager);
                break;
            case 2:
                BaseManager.baseActions(player, new Scanner(System.in));
                break;
            case 3:
            ...
            case 4:
                ...
                String saveName = new Scanner(System.in).next();
                GameSaveManager.saveGame(player, saveName);
                break;
            case 5:
                startBattle(player, random, new Scanner(System.in));
                break;
            case 6:
                ...
                break;
            case 7:
                setVolume(new Scanner(System.in));
                break;
            case 8:
            ...
            case 9:
                ...
                if (saves.isEmpty()) {
                    ...
                    int saveChoice = new Scanner(System.in).nextInt();
                ...
                break;
            case 10:
                managePets(player, new Scanner(System.in));
                break;
            default:
